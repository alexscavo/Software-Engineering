...
const USER_WRONG_PARAMETER = "Inserted parameter are either not correct or empty"
...
class WrongParametersError extends Error {
    ...
    constructor() {
        super()
        this.customMessage = USER_WRONG_PARAMETER
        this.customCode = 400
    }
}

export { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UnauthorizedUserError, WrongParametersError }